"""
final full-data training run, SAGE + autoencoder RNA embedding
"""

import argparse
import torch

from gnn_v4 import run_gnn_v4
...
def main():
    ...
    parser.add_argument("--latent_dim", type=int, default=128,
                         help="autoencoder embedding size (analogous to n_svd_components)")
    parser.add_argument("--ae_epochs", type=int, default=100)
    parser.add_argument("--ae_hidden_dims", type=int, nargs="+", default=[1024, 512],
                         help="autoencoder hidden layer sizes, e.g. --ae_hidden_dims 1024 512")
